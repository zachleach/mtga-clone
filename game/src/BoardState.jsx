...
export const BoardStateProvider = ({ children, modifyHandlers }) => {
  /* STATE */
  ...
  const handlers = modifyHandlers ? modifyHandlers(base_handlers) : base_handlers
